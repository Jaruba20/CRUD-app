...
def main():
    ...
    user_query_parser = subparsers.add_parser('entry_query', help='Entry a hole MySQL query')
    ...
    delete_parser = subparsers.add_parser('delete', help='Delete a song/songs of the music db')
   ...
   # Subparser for the 'update' command
    update_parser = subparsers.add_parser('update', help='Update a song/songs of the music db')
    update_parser.add_argument('--song', help='Name of the song(condition)', default=None)
    update_parser.add_argument('--album', help='Name of the album(condition)', default=None)
    update_parser.add_argument('--artist', help='Name of the artist(condition)', default=None)
    update_parser.add_argument('--genre', help='Name of the genre(condition)', default=None)    
    update_parser.add_argument('--set_song', help='Name of the song to set', default=None)
    update_parser.add_argument('--set_album', help='Name of the album to set', default=None)
    update_parser.add_argument('--set_artist', help='Name of the artist to set', default=None)
    update_parser.add_argument('--set_genre', help='Name of the genre to set', default=None)
    ...
    match args.command:
        ...
        case "search":
            search_song_by(song=args.song, album=args.album, artist=args.artist, genre=args.genre)
        case "delete":
            delete_song_by(song_id = args.song_id, song=args.song, album=args.album, artist=args.artist, genre=args.genre)
        case "update":
            update_song_by(set_song=args.set_song, set_album=args.set_album, set_artist=args.set_artist, set_genre=args.set_genre,
